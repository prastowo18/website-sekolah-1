...
const optionalSubjectSchema = z.preprocess(
  normalizeOptionalString,
  z.string().trim().max(220, "Subjek terlalu panjang.").optional(),
);
...
export const publicContactMessageSchema = z
  .object({
    ...
    message: z
      ...
      .max(3000, "Pesan maksimal 3.000 karakter."),

    website: z.string().trim().max(300).optional().default(""),

    startedAt: z.string().trim().max(30).optional().default(""),
  })
