...
import {
  ProgramFormDialog,
} from "@/features/program/components/program-form-dialog";
import {
  ProgramTable,
} from "@/features/program/components/program-table";
...
export default async function ProgramPage({
  ...
  const totalPages = Math.max(
    1,
    Math.ceil(totalPrograms / PAGE_SIZE),
  );
  ...
  const serializedPrograms = programs.map(
    (program) => ({
      ...program,
      publishedAt:
