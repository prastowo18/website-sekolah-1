...
function MediaCover({
  ...
  return (
    <div
      ...
      data-homepage-media-cover="true"
    >
      <Image
        src={safeUrl}
        alt={label}
  ...
  return (
    <main>
      ...
      >
        {heroImage ? (
          <>
            <Image
              ...
              sizes="100vw"
              aria-hidden="true"
              data-lcp-element="homepage-hero-image"
              className="pointer-events-none absolute inset-0 z-0 select-none object-cover"
            />

            <div
              aria-hidden="true"
              className="pointer-events-none absolute inset-0 z-10 bg-[linear-gradient(90deg,rgba(9,18,34,0.92),rgba(9,18,34,0.58),rgba(9,18,34,0.28))]"
            />
          </>
        ) : null}
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 z-20 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.18),transparent_38%)]"
        />

        <div className="relative z-30 mx-auto flex min-h-155 max-w-7xl items-center px-4 py-20 sm:px-6 lg:px-8">
          <MotionStagger
            className="max-w-3xl"
            stagger={0.12}
            distance={52}
