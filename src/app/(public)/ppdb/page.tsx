...
export default async function PublicPpdbPage() {
  ...
  const brochureAvailable = isSafePublicUrl(ppdb.brochureUrl);

  const externalRegistrationAvailable =
    ppdb.showExternalRegistrationButton &&
    isSafePublicUrl(ppdb.externalRegistrationUrl);
